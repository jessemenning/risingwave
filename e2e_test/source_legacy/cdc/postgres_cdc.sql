...
DROP TABLE IF EXISTS composite_auto_change_table;
...
CREATE TABLE composite_auto_change_table (
    id int PRIMARY KEY,
    total money_type
);

INSERT INTO composite_auto_change_table VALUES
    (1, ROW('USD', 1.23)::money_type);
